...
export function MobileBottomNav({
  ...
  return (
    <nav
      className="nm-bottom-nav fixed inset-x-0 bottom-0 z-[150] border-t bg-background pb-[env(safe-area-inset-bottom)] shadow-[0_-1px_3px_rgba(0,0,0,0.08)] print:hidden"
