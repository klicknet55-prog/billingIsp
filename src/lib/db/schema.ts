...
export const communityDonations = active.communityDonations as typeof sqlite.communityDonations;
...
export type CommunityDonation = typeof sqlite.communityDonations.$inferSelect;
